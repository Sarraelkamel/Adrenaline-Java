...
public class AddCategoryInterfaceController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        tv_categories.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                if (tv_categories.getSelectionModel().getSelectedItem() != null) {
                    ...
                    IdCategorieTF.setText(String.valueOf(selectedCategorie.getId_ca()));
                    nomCategorieTF.setText(String.valueOf(selectedCategorie.getNom_ca()));
                } else {
        ...
        col_idCat.setCellValueFactory(new PropertyValueFactory<>("id_ca"));
        col_nomCategorie.setCellValueFactory(new PropertyValueFactory<>("nom_ca"));
        listCat.forEach((c) -> {
            tv_categories.getItems().add(new Categorie(c.getId_ca(), c.getNom_ca()));
        });
    }
