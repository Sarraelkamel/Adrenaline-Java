...
public class Sponsor {
    ...
    public Sponsor(String nom_sp, int num_sp, String email_sp) {
        this.nom_sp = nom_sp;
        this.num_sp = num_sp;
        this.email_sp = email_sp;
    }
    ...
    public Sponsor(int aInt, String string) {
    ...
    public String toString() {
        return "Sponsor{" + "id=" + id + ", nom_sp=" + nom_sp + ", num_sp=" + num_sp + ", email_sp=" + email_sp + '}';
    }
